    ...
    <div class="container-fluid">
        <div class="card w-75 mx-auto mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Cashier profile:
            </div>
            <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">${cashier.name} ${cashier.surname}</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-3 col-lg-3 " align="center">
                                        <img alt="User Pic" style="width: 170px;height: 170px;"
                                             src="${cashier.imageUrl}" class="rounded-circle img-responsive">
                                    </div>
                                    <br>
...
<c:if test="${not empty transactions}">
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-area-chart"></i> Total transactions of ${cashier.name} cashier</div>
            <div class="card-body">
